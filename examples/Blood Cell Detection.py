...
image_path = '../dataset/bloodcell/JPEGImages/'
annot_path = '../dataset/bloodcell/Annotations/'

all_imgs, seen_labels = parse_annotation_voc(annot_path, image_path)
...
batches = BatchGenerator(all_imgs, generator_config, norm=None).get_generator()


# In[14]:

image = next(batches)[0][0][0]
...
valid_batch = BatchGenerator(all_imgs[train_valid_split:], generator_config, jitter=False)
...
image = cv2.imread('../dataset/bloodcell/JPEGImages/BloodImage_00032.jpg')
